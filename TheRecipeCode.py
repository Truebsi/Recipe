...
def show_filtered_recipes():
    ...
    #filtered_recipes = [b for b in filtered_recipes_search if b]
    #filtered_recipes = filtered_recipes_search[filtered_recipes_search['vegetarisch'].bool.equal == selected_categories[0]] | filtered_recipes_search[filtered_recipes_search['vegan'].bool == selected_categories[1]]
    st.write(f"Kat: {st.session_state.selected_categories}")
